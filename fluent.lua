-- Bundled Fluent UI (auto-generated)
...
-- FILE: Acrylic/CreateAcrylic.lua
...
-- FILE: Components/Notification.lua
local Root = script.Parent.Parent
local Flipper = require(Root.Packages.Flipper)
local Creator = require(Root.Creator)
local Acrylic = require(Root.Acrylic)
...
-- FILE: Packages/Flipper/BaseMotor.lua
local RunService = game:GetService("RunService")
...
-- FILE: Packages/Flipper/BaseMotor.spec.lua
return function()
	local RunService = game:GetService("RunService")
...
-- FILE: Packages/Flipper/GroupMotor.lua
local BaseMotor = require(script.Parent.BaseMotor)
...
-- FILE: Packages/Flipper/GroupMotor.spec.lua
return function()
...
-- FILE: Packages/Flipper/Instant.lua
local Instant = {}
...
-- FILE: Packages/Flipper/Instant.spec.lua
return function()
	local Instant = require(script.Parent.Instant)
...
-- FILE: Packages/Flipper/Linear.lua
local Linear = {}
...
-- FILE: Packages/Flipper/Linear.spec.lua
return function()
	local SingleMotor = require(script.Parent.SingleMotor)
...
-- FILE: Packages/Flipper/Signal.lua
local Connection = {}
...
-- FILE: Packages/Flipper/Signal.spec.lua
return function()
	local Signal = require(script.Parent.Signal)
...
-- FILE: Packages/Flipper/SingleMotor.lua
local BaseMotor = require(script.Parent.BaseMotor)
...
-- FILE: Packages/Flipper/SingleMotor.spec.lua
return function()
	local SingleMotor = require(script.Parent.SingleMotor)
	local Instant = require(script.Parent.Instant)
...
-- FILE: Packages/Flipper/Spring.lua
...
-- FILE: Packages/Flipper/Spring.spec.lua
return function()
	local SingleMotor = require(script.Parent.SingleMotor)
	local Spring = require(script.Parent.Spring)
...
-- FILE: Packages/Flipper/init.lua
local Flipper = {
...
-- FILE: Packages/Flipper/isMotor.lua
...
-- FILE: Packages/Flipper/isMotor.spec.lua
return function()
	local isMotor = require(script.Parent.isMotor)
